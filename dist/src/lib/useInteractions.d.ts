 ...
 */
export declare function useInteractions(paginator: Paginator, result: PaginatedResult | null, hostRef: RefObject<HTMLElement | null>, options?: AttachInteractionsOptions): UseInteractionsResult;
